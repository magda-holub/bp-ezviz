...
const swiper = new Swiper('.swiper', {
  ...
  $(document).ready(function () {
    $("h1").insertAfter("#categoryUpperDescription"),
        $("h1").insertAfter("#categoryUpperDescription");
});
...
function marker(e){
    ...
    let infoboxes = document.querySelectorAll('.bp-automation--infobox');

    infoboxes.forEach(card => {
        card.classList.remove('bp-infobox__visible');
    });

    for(var i = 0; i < infoboxBoth.length; i++)
    {
        infoboxBoth[i].classList.add('bp-infobox__visible');
    }
};